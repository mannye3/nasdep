                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
											...
											<tbody>
												...
												<tr>
													...
													<td>{{ $investor->company->type }}</td>
													<td>{{ $investor->company->addr }}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('adminViewInvestor', $investor->company_id)}}" class="fa fa-search" title="View account"></a>&nbsp;

                                                        <a href=""  data-toggle="modal" data-target="#ChangeinvestorStatusModal-{{ $investor->id}}" class="fas fa-adjust" title="Change Status"></a>&nbsp;


                                                        <a href=""  data-toggle="modal" data-target="#deleteinvestorModal-{{ $investor->id}}" class="fas fa-trash-alt" title="Delete Account"></a>&nbsp;
