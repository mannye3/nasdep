                            ...
                            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap mr-1">
                                    ...
                                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                                        <!--begin::Page Title-->
                                        <h5 class="text-dark font-weight-bold my-1 mr-5">ALL INCUBATORS</h5>
                                        <!--end::Page Title-->
                                        <!--begin::Breadcrumb-->
                                        ...
                                        <table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
											...
											<tbody>
												...
												<tr>
                                                    ...
                                                    <td>{{ $incubator->created_at }}</td>
                                                    <td>{{$incubator->updated_at}}</td>
													{{-- <td>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('adminViewIncubator', $incubator->company_id)}}" class="fa fa-search" title="View account"></a>&nbsp;

                                                        <a href=""  data-toggle="modal" data-target="#ChangeUserStatusModal-" class="fas fa-adjust" title="Change Status"></a>&nbsp;


                                                        <a href=""  data-toggle="modal" data-target="#deleteUserModal-" class="fas fa-trash-alt" title="Delete Account"></a>&nbsp;
