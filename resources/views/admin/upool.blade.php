        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ $upool->name }}</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href=" {{ route('admin.upools')}}" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="mr-3">
                                    <div class="d-flex align-items-center mr-3">
                                        ...
                                        <span class="label label-light-success label-inline font-weight-bolder mr-1">{{ $upool->industry->name }}</span>
                                    </div>
                                    <!--begin::Contacts-->
                                        ...
                                        <div class="card card-custom">
											...
											<div class="card-body py-4">
												<div class="form-group row my-2">
													...
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{ $upool->country->name }}</span>
													</div>
												</div>
                                                ...
                                                <div class="form-group row my-2">
													...
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{ $upool->state->name }}</span>
													</div>
												</div>
												...
												<div class="form-group row my-2">
													...
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{ $upool->exp }}</span>
													</div>
												</div>

												<div class="form-group row my-2">
													<label class="col-4 col-form-label">REG Number:</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{$upool->number}}</span>
													</div>
												</div>
                                                ...
                                                <div class="form-group row my-2">
													...
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{$upool->growth_stage}}</span>
													</div>
												</div>


												<div class="form-group row my-2">
													<label class="col-4 col-form-label">Type of investor:</label>
													<div class="col-8">
                                                ...
                                                <div class="form-group row my-2">
													<label class="col-4 col-form-label">Type of funding required:</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">
												        {{$upool->tof}}
														</span>
												...
												<div class="form-group row my-2">
													<label class="col-4 col-form-label">Year of last audited financials :</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">
                                                            {{$upool->ylaf}}
														</span>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-9">
                                                        <h6 class="text-dark font-weight-bold mb-10">Registrant:</h6>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            <div class="my-2">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        ...
                                                        @else
                                                        <div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar"
                                                        style="background-image: url({{ $upool->logo }})">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="name" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->name}}" />
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            <!--begin::Group-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="number" type="text" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->number}}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="exp" type="number" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->exp}}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="growth_stage" type="text" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->growth_stage}}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-3 text-lg-right text-left"> Type of investor</label>
                                                <div class="col-9">
                                                    <input name="toi" type="text" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->toi}}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-3 text-lg-right text-left"> Type of funding required:</label>
                                                <div class="col-9">
                                                    <input name="tof" type="text" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->tof}}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-3 text-lg-right text-left"> Year of last audited financials :</label>
                                                <div class="col-9">
                                                    <input name="ylaf" type="date" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->ylaf }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-form-label col-3 text-lg-right text-left"> Turnover</label>
                                                <div class="col-9">
                                                    <input name="ylaf_turnover" type="number" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->ylaf_turnover}}" />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="amount" type="number" class="form-control form-control-lg form-control-solid" type="text" value="{{ $upool->amount}}" />
