        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <div class="d-flex align-items-center" id="kt_subheader_search">
                    <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">{{ $company->name }}</span>
                </div>
                <!--end::Search Form-->
            </div>
            <!--end::Details-->
            ...
            <div class="d-flex align-items-center">
                <!--begin::Button-->
                <a href=" {{ route('admin.investors')}}" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="mr-3">
                                    <div class="d-flex align-items-center mr-3">
                                        ...
                                        <span class="label label-light-success label-inline font-weight-bolder mr-1">{{ $company->industry->name }}</span>
                                    </div>
                                    <!--begin::Contacts-->
                                        ...
                                        <div class="card card-custom">
											...
											<div class="card-body py-4">
												<div class="form-group row my-2">
													...
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{$company->addr}}</span>
													</div>
												</div>
												<div class="form-group row my-2">
													<label class="col-4 col-form-label">Country:</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{ $company->country->name }}</span>
													</div>
												</div>
												<div class="form-group row my-2">
													<label class="col-4 col-form-label">State:</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{ $company->state->name }}</span>
													</div>
												</div>
												<div class="form-group row my-2">
													<label class="col-4 col-form-label">REG NO:</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">{{$company->number}}</span>
													</div>
												</div>
												<div class="form-group row my-2">
													<label class="col-4 col-form-label">DOI:</label>
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">
															<a href="#">{{$company->doi}}</a>
														</span>
													</div>
												</div>
												...
												<div class="form-group row my-2">
													...
													<div class="col-8">
														<span class="form-control-plaintext font-weight-bolder">
															<a href="#">{{ $company->enterprise->count() }}</a>
														</span>
													</div>
												</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-7">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="name" class="form-control form-control-lg form-control-solid" type="text" value="{{ $company->name}}" />
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            <!--begin::Group-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <input name="number" class="form-control form-control-lg form-control-solid" type="text" value="{{ $company->number}}" />
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                            <!--begin::Group-->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input name="addr" type="text" class="form-control form-control-lg form-control-solid" value="{{ $company->addr}}"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input name="doi" type="date" class="form-control form-control-lg form-control-solid" value="{{ $company->doi}}"  />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input name="ind_exp" type="text" class="form-control form-control-lg form-control-solid" value="{{ $company->ind_exp}}" />
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Group-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <div class="input-group input-group-lg input-group-solid">
                                                            ...
                                                            <input name="website" type="text" class="form-control form-control-lg form-control-solid" value="{{ $company->website}}" placeholder="Email" />
                                                        </div>
                                                    </div>
                                                </div>
