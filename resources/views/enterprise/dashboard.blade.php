...
<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
    <div class="ff_one style2">
        ...
        <div class="detais">
            {{-- <div class="timer"></div> --}}
           <p style="font-size: 30px"> {{ \App\Models\Analyst::all()->count() }} </p>
            <p  style="font-size: 20px">Analysts</p>
        </div>
    </div>
</div>
<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
    <div class="ff_one style3">
        ...
        <div class="detais">
            ...
            <p style="font-size: 30px"> {{ \App\Models\Investor::all()->count() }}  </p>
            <p  style="font-size: 20px">Investors</p>
        </div>
    </div>
</div>
<div class="col-sm-6 col-md-6 col-lg-6 col-xl-4">
    <div class="ff_one style4">
        ...
        <div class="detais">
            ...
            <p  style="font-size: 20px"> {{ \App\Models\Incubator::all()->count() }} </p>
            <p  style="font-size: 20px">Incubators</p>
        </div>
    </div>
</div>
